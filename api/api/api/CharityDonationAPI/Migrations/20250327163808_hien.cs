        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VerificationDocumentUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuickDonations", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuickDonations_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampaignSubscriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CampaignSubscriptions_Campaigns_CampaignId",
                        column: x => x.CampaignId,
                        principalTable: "Campaigns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CampaignSubscriptions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Chiến dịch hỗ trợ y tế, chăm sóc sức khỏe", "Y tế" },
                    { 2, "Chiến dịch hỗ trợ giáo dục, học bổng", "Giáo dục" },
                    { 3, "Hỗ trợ khắc phục hậu quả thiên tai", "Thiên tai" },
                    { 4, "Hỗ trợ cho trẻ em có hoàn cảnh khó khăn", "Trẻ em" },
                    { 5, "Hỗ trợ người già neo đơn, khó khăn", "Người già" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Người dùng thông thường", "No-User" },
                    { 4, "Người tạo chiến dịch", "Creator" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignSubscriptions_CampaignId",
                table: "CampaignSubscriptions",
                column: "CampaignId");

            migrationBuilder.CreateIndex(
                name: "IX_CampaignSubscriptions_UserId",
                table: "CampaignSubscriptions",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuickDonations_TransactionId",
                table: "QuickDonations",
                column: "TransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_QuickDonations_UserId",
                table: "QuickDonations",
                column: "UserId");
